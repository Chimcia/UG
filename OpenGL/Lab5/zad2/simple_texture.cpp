...

{
	...
	0.4f, 0.0f, // for bottom right vertex
	0.0f, 1.0f, // for upper vertex
...

{
    ...
    glUniform1f( glGetUniformLocation( program, "horizontal_shift" ), horizontal_shift);
...

{
	...
	CreateTexture("background_smog.bmp", 0);
	glActiveTexture(GL_TEXTURE1);
	CreateTexture("background.bmp", 1);
