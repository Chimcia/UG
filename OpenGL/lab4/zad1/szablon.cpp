...
void Initialize()
{
	...
	glAttachShader( idProgram, LoadShader(GL_VERTEX_SHADER, "vertex-1.glsl"));
	glAttachShader( idProgram, LoadShader(GL_FRAGMENT_SHADER, "fragment-1.glsl"));
...
int main( int argc, char *argv[] )
{
	...
	glutCreateWindow( "Wiele programow - nacisnij SPACE aby zmienic program" );
